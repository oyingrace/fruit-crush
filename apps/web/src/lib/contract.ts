...
export const CONTRACT_ADDRESS = "0xb6585f51d25Af8D48b0995B1eb110df6a3Bf5912"; // Replace with actual contract address
...
export const contract = getContract({
  ...
  chain: { id: CHAIN_ID, rpc: "https://forno.celo.org" },
  abi: CONTRACT_ABI,
});

// Types for mint request
